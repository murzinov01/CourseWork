...
class Messages:
    ...
    SUBSCRIBED_TAG = 'Подписка по тэгу "<b>{}</b>" оформлена. Я буду оповещать тебя, когда будут появляться новые статьи! 😉'
    UNSUBSCRIBED_TAG = 'Подписка по тэгу "<b>{}</b>" отключена. Теперь я не буду присылать тебе оповещения о статьях по этому тэгу 👌'
    ...
    NOT_FOUND_TAG_SUBSCRIPTIONS = (
        "Кажется, ты не подписан на получение статей ни по одному тэгу ☹\nПодпишись и читай самые свежие статьи Хабра первым! 😏"
    )
