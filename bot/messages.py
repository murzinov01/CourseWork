...
class Messages:
    ...
    SUBSCRIBED_THEME = 'Подписка на тему "<b>{}</b>" оформлена. Я буду оповещать тебя, когда будут появляться новые статьи! 😉'
    UNSUBSCRIBED_THEME = (
    ...
    NOT_FOUND_SUBSCRIPTIONS = "Кажется ты ещё не подписался ни на одну рассылку ☹\nПодпишись и читай самые свежие статьи Хабра первым! 😏"
    SUBSCRIPTIONS_LIST = "Ты хочешь получить список твоих пидписок?"
    NEED_HELP = "Кажется тебе нужна помощь? Расскзать, что я умею?"
    IS_SURE_TO_DELETE = "Ты уверен, что хочешь отписаться от рассылки новых статей <b>по всем параметрам</b> (авторы, темы, тэги?)"
