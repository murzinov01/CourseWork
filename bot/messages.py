...
class Messages:
    ...
    SUBSCRIBED_THEME = 'Подписка на тему "{}" оформлена. Я буду оповещать тебя, когда будут появляться новые статьи! 😉'
    UNSUBSCRIBED_THEME = (
        'Подписка на тему "{}" отключена. Теперь я не буду присылать тебе оповещения о статьях на эту тему 👌'
    )
